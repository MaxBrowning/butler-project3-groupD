...
def predict():
    if request.method == 'POST':
        ...
        print([[Total_Assessed_Value, Parcel_Acreage, Class_Code_Translated_Agricultural, Class_Code_Translated_Commercial, Class_Code_Translated_Exempt, Class_Code_Translated_Industrial, Class_Code_Translated_Locally_Assessed, Class_Code_Translated_Mineral, Class_Code_Translated_Residential, Vacant]])
